...
public class HttpManager {
     ...
     */
    public void doHttpDeal(BaseApi basePar,Observable observable) {
        ...
        /*rx处理*/
        ProgressSubscriberApi subscriber = new ProgressSubscriberApi<>(basePar);
                 observable
                 /*失败后的retry配置*/
...
//                .compose(basePar.getRxAppCompatActivity().bindToLifecycle())
        ...
        /*链接式对象返回*/
        SoftReference<OnNextListener> httpOnNextListener = basePar.getListener();
