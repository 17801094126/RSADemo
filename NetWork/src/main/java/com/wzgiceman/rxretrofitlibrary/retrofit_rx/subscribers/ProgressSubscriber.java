...
public class ProgressSubscriber<T> extends Subscriber<T> {
     ...
     * 构造
     */
    public ProgressSubscriber(RxAppCompatActivity rxAppCompatActivity,String cacheUrl,boolean isCache,int cookieNoNetWorkTime,int netWorkTime,OnNextListener mSubscriberOnNextListener) {
     ...
     *
     */
    public ProgressSubscriber(String cacheUrl,boolean isCache,RxAppCompatActivity rxAppCompatActivity,OnNextListener mSubscriberOnNextListener) {
        this.cacheUrl=cacheUrl;
        this.isCache=isCache;
        this.mSubscriberOnNextListener =new SoftReference<OnNextListener>(mSubscriberOnNextListener);
